...
/* @var $model common\models\OrganizationUserRelation */
/* @var $parentModel common\models\OrganizationUserRelationInvitation */

/*echo "<pre>";
var_dump($parentModel->rules());
echo "</pre>";
exit;*/
...
$this->registerJsFile('@web/js/pageScripts/userInvite.js',['depends' => [\yii\web\JqueryAsset::className()]]);
?>
    ...
    <div class="card">
        ...
        <div class="card-body borderTop">
            ...
            <div class="col-md-6 mb-2">
                <?= $form->field($parentModel, 'sent_to')->dropdownList(OrganizationUserRelationInvitation::getInviteMethods(), ['prompt' => ['text' => Yii::t('core_system', 'Select send option'), 'options' => ['disabled' => true, 'selected' => true]]])->label(Yii::t('core_organization', 'Invite user via') . '*') ?>
                <?= $form->field($parentModel, 'sent_to_mobile')->label(Yii::t('core_system', 'Send to mobile'))->widget(PhoneInput::className(), [
                    'options'   =>  [
                ...
                <?= $form->field($parentModel, 'sent_to_email', ['options' => ['class' => 'form-group']])->input('email', ['id' => 'invite-input-Email'])->label(Yii::t('core_system', 'Send to email')) ?>
