...
$this->title = Yii::t('core_organization', 'Register Team');
...
?>
    ...
    <div class="col-12 mb-4">
        ...
        <h2><?=Yii::t('core_organization', 'Register Team')?></h2>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4><?=Yii::t('core_organization', 'New Team')?></h4>
            </div>
            <div class="card-body borderTop">
                <div class="row">
                    <div class="col-md-12">
                        <?= $form->field($model, 'name', ['options' => ['class' => 'form-group']])->textInput(['maxlength' => true]) ?>
                        <?= $form->field($model, 'sport', ['options' => ['class' => 'form-group']])->textInput(['maxlength' => true]) ?>
