...
$checkOrganization = strpos($_SERVER['REQUEST_URI'], 'organization');
    ...
    <div class="card">
        <div class="card-header">
            <span class="float-right mt-2">
                <?= Html::a(Yii::t('core_system', 'Update'), ['update-organization', 'id' => $model->id], ['class' => 'btn btn-warning mr-3']) ?>
            ...
            <div class="row">
                ...
                ?>
                    <table class="table table-striped">
                        ...
                        <?php
                        foreach ($model->organizationApiKeys as $module) {
                            $organizationModuleRelation = OrganizationModuleRelation::findOne($module->cmr_id);
                            $moduleName = Module::findOne(['id' => $organizationModuleRelation->module_id]);
                            ?>
                            <tr>
                                <?php
                                if ($organizationModuleRelation->module_id !== 'siteAdmin' && $organizationModuleRelation->module_id !== 'systemAdmin') {
                                    ?>
                                    <td><?=Yii::t('module', $moduleName->name) ?></td>
                                <?php
                                }
                                    ...
                                    if ($organizationModuleRelation->module_id !== 'siteAdmin' && $organizationModuleRelation->module_id !== 'systemAdmin') {
                                        ...
                                        <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                            ...
                                            <div class="dropdown-menu">
                                                <?= Html::a('<i class="fas fa-check-square fa-2x"></i> ' . Yii::t('core_system', 'Has access'), ['update-rights', 'id' => $model->id, 'module_id' => $organizationModuleRelation->id, 'right' => $ra, 'value' => 1, 'site' => $site], [
                                                    'class' => 'dropdown-item',
                                                    'data' => [
                                                        'method' => 'post',
                                                    ],
                                                ]);?>
                                                <?= Html::a('<i class="fas fa-times-square fa-2x"></i> ' . Yii::t('core_system', 'No access'), ['update-rights', 'id' => $model->id, 'module_id' => $organizationModuleRelation->id, 'right' => $ra, 'value' => 0, 'site' => $site], [
                                                    'class' => 'dropdown-item',
                                                    'data' => [
                                                        'method' => 'post',
                                                    ],
