...
<div class="row">
    <div class="col-xl-4">
        <div class="card mb-4">
            ...
            <br><div class="col-12">
                <?= $form->field($model, 'first_name', ['options' => ['class' => 'form-group']])->textInput(['maxlength' => true])->label(Yii::t('core_system', 'First name') . '*') ?>
            </div>
            <div class="col-12">
                <?= $form->field($model, 'last_name', ['options' => ['class' => 'form-group']])->textInput(['maxlength' => true])->label(Yii::t('core_user', 'Last name') . '*') ?>
            </div>
