...
class NotificationHelper
{
    public function alertBell()
    {
        ...
        //echo "<span class='position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger'>3<span class='visually-hidden'>unread messages</span></span>";
        echo "</button>
        ...
        self::alertTabContent();
        echo "</div></div></div>";
    }

    public function alertTabContent()
    {
        echo "<div class='tab-pane fade show active py-2 ps-2' id='all-noti-tab' role='tabpanel'>
