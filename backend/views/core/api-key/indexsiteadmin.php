...
<div class="col-12 mb-4">
    ...
    <h2><?=Yii::t('core_system', 'Api Keys')?></h2>
</div>
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <span class="float-right mt-2">
                    <?= Html::a('+ ' . Yii::t('core_system', 'Create Api Key'), ['create-siteadmin'], ['class' => 'btn btn-warning']) ?>
                </span>
            <h4><?=Yii::t('core_system', 'All Api Keys')?></h4>
        </div>
        <div class="card-body indexView">
            <?= GridView::widget([
                'dataProvider' => $dataProvider,
                'filterModel' => $searchModel,
                'columns' => ApiKey::getIndexSiteAdminNoSettings(),
