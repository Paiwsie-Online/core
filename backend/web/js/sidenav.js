                    ...
                    function e(n) {
                        ...
                        if (
                            (i(this, e),
                                ...
                                (this._animate = !1 !== t.animate && this._supportsTransitionEnd()),
                                ...
                                n.classList[this._animate ? "remove" : "add"]("sidenav-no-animation"),
                                this._horizontal)
                        ) {
                            ...
                            this._prevBtn || ((this._prevBtn = document.createElement("a")), (this._prevBtn.href = "#"), (this._prevBtn.className = "sidenav-horizontal-prev"), o.appendChild(this._prevBtn)),
                                (this._wrapper = n.querySelector(".sidenav-horizontal-wrapper")),
                            this._wrapper || ((this._wrapper = document.createElement("div")), (this._wrapper.className = "sidenav-horizontal-wrapper"), this._wrapper.appendChild(this._inner), o.appendChild(this._wrapper)),
                                (this._nextBtn = n.querySelector(".sidenav-horizontal-next")),
                            this._nextBtn || ((this._nextBtn = document.createElement("a")), (this._nextBtn.href = "#"), (this._nextBtn.className = "sidenav-horizontal-next"), o.appendChild(this._nextBtn)),
                                (this._innerPosition = 0),
                                this.update();
                        } else {
                            n.classList.add("sidenav-vertical"), n.classList.remove("sidenav-horizontal");
                            var r = s || window.PerfectScrollbar;
                            r && (this._scrollbar = new r(n.querySelector(".sidenav-inner"), { suppressScrollX: !0, wheelPropagation: !0 }));
                        }
                        ...
                        (t = [
                                        ...
                                        this._promisify(this._onOpen, this, i, s, this._findMenu(i))
                                            .then(function () {
                                                n._horizontal && n._isRoot(i)
                                                    ? (n._toggleDropdown(!0, i, t), n._onOpened && n._onOpened(n, i, s, n._findMenu(i)))
                                                    : n._animate
                                                        ? (window.requestAnimationFrame(function () {
                                                            return n._toggleAnimation(!0, i, !1);
                                                        }),
                                                        n._accordion && n._closeOther(i, t))
                                                        : (i.classList.add("open"), n._onOpened && n._onOpened(n, i, s, n._findMenu(i)), n._accordion && n._closeOther(i, t));
                                            })
                                            .catch(function () {});
                                    }
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this._promisify(this._onClose, this, s, o, this._findMenu(s), i)
                                        .then(function () {
                                            if (n._horizontal && n._isRoot(s)) n._toggleDropdown(!1, s, t), n._onClosed && n._onClosed(n, s, o, n._findMenu(s));
                                                ...
                                                if ((s.classList.remove("open"), t)) for (var e = s.querySelectorAll(".sidenav-item.open"), i = 0, r = e.length; i < r; i++) e[i].classList.remove("open");
                            ...
                            },
                            {
                                key: "closeAll",
                                value: function () {
                                    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._closeChildren, n = this._el.querySelectorAll(".sidenav-inner > .sidenav-item.open"), t = 0, i = n.length; t < i; t++)
                                        this.close(n[t], e);
                                },
                            },
                            {
                                ...
                                value: function (e, n) {
                                    var t = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
                                        ...
                                        s = this._getItem(e, !1);
                                    if (n && i) for (var o = this._el.querySelectorAll(".sidenav-inner .sidenav-item.active"), r = 0, l = o.length; r < l; r++) o[r].classList.remove("active");
                                    if (n && t) {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (this._el) {
                                        this._unbindEvents();
                                        for (var e = this._el.querySelectorAll(".sidenav-item"), n = 0, t = e.length; n < t; n++)
                                            this._unbindAnimationEndEvent(e[n]), e[n].classList.remove("sidenav-item-animating"), e[n].classList.remove("open"), (e[n].style.overflow = null), (e[n].style.height = null);
                            ...
                            },
                            {
                                ...
                                value: function (e, n) {
                                    var t = null,
                                        i = n ? "sidenav-toggle" : "sidenav-link";
                                    if ((e.classList.contains("sidenav-item") ? this._findChild(e, [i]).length && (t = e) : e.classList.contains(i) && (t = e.parentNode.classList.contains("sidenav-item") ? e.parentNode : null), !t))
                                        throw new Error("".concat(n ? "Toggable " : "", "`.sidenav-item` element not found."));
                                    return t;
                                },
                            },
                            {
                                    ...
                                    for (var s = 0, o = (t = t.slice(0, t.indexOf(i))).length; s < o; s++)
                                        if ((t[s].classList.add("open"), this._accordion))
                                            for (var r = this._findChild(t[s].parentNode, ["sidenav-item", "open"]), l = 0, a = r.length; l < a; l++)
                                                if (r[l] !== t[s] && (r[l].classList.remove("open"), n)) for (var d = r[l].querySelectorAll(".sidenav-item.open"), h = 0, c = d.length; h < c; h++) d[h].classList.remove("open");
                                    return i;
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (e, n, t) {
                                    ...
                                    e
                                        ...
                                        : ((n.style.height = "".concat(r + Math.round(o.getBoundingClientRect().height), "px")),
                                            n.classList.add("sidenav-item-animating"),
                                            n.classList.add("sidenav-item-closing"),
                                            this._bindAnimationEndEvent(n, function () {
                                                if ((n.classList.remove("open"), l(), t)) for (var e = n.querySelectorAll(".sidenav-item.open"), r = 0, a = e.length; r < a; r++) e[r].classList.remove("open");
