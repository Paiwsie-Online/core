        ...
        335: function (t, e, n) {
            ...
            var l = {
                ...
                _setCollapsed: function (t) {
                    ...
                    /*Original minimize sidebar for large screens*/
                    /*this.isSmallScreen()
                        ? t
                            ? this._removeClass("layout-expanded")
                            : setTimeout(
                ...
                on: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : u("event"),
                        ...
                        a = o[0],
                        s = o.slice(1);
                    (s = s.join(".") || null), this._listeners.push({ event: a, namespace: s, callback: e });
                },
                off: function () {
                    var t = this,
            ...
            "undefined" != typeof window &&
            (l.init(),
            l.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-sidenav-100vh"),
