            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card border-info">
                        <div class="card-header cardHeader">
                            <h5><?=Yii::t('core_user', 'Information')?></h5>
                        </div>
                        <div class="card-body borderTop cardContent">
                            <span class="poppinsStrong"><?=Yii::t('core_user', 'This is not a public profile')?>, </span>
                            <?=Yii::t('core_user', ' this profile page is for you to see what information is saved about you within the system and to be able to see what organizations you are connected to and what you have access to within each organization. <p>We try to not save more data than what is necessary in order to identify you and to have full functionality of the system.</p>')?>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
