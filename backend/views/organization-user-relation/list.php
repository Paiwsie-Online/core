        ...
        <div class="card-body indexView">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' =>  'athletes',
                        'label' => Yii::t('core_organization', 'Athletes'),
                        //'filter'    =>  (new common\models\User)->getAthletes(),
                        'value' =>  function($data) {
               // return  var_dump($data->organization->id);



                        /*    foreach ($athletes as $athlete) {
                                echo $athlete->first_name;
                            }*/
                            if ($data->user) {
                                $user = User::find()->where(['id' => $data->user_id])->one();
                                $returnValue = [];
                                foreach ($user->athletesByTeam($data->organization->id) as $athlete) {
                                    $returnValue[] = $athlete->first_name;
                                }
